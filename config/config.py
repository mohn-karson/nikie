config = {
    'MODELS': {
        '': r'./models/DocumentType.joblib',
        'PAYMENT-DUE': r'./models/PaymentDue.joblib',
        'CLASSIFIER': r'./models/'
    },
    ...
    'OFF': {
        'REQUIRED-COLUMNS': ['code', 'product_name', 'image_nutrition_url', 'energy-kj_100g', 'energy-kcal_100g', 'energy_100g', 'energy-from-fat_100g', 'fat_100g',
